...
const merkleDistributor = require("../deployments/fork/MerkleDistributor.json").address
...
async function run() {
  ...
  const poolToken = await ethers.getContractAt('TestERC20', poolAddress, gnosisSafe)
  ...
  let claimeeBalance = await poolToken.balanceOf("0x9C6EFFf83578a1049E91106F071A24Ba5313B9e9")
  ...
  if(!(await merkleDistributorContract.isClaimed(proof.index))){
    ...
    claimeeBalance = await poolToken.balanceOf("0x9C6EFFf83578a1049E91106F071A24Ba5313B9e9")
